...
export function VlogModal({ onClose }: { onClose: () => void }) {
  const driveUrl = "https://drive.google.com/file/d/1UFDQz1DT-qx6uNtLpKleiIS59hZh0N3Q/preview";
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      ...
      >
        <div className="bg-[#bfdbfe] border-b-4 border-black p-4 flex justify-between items-center shrink-0">
          <div className="flex items-center gap-3">
            <div className="bg-white border-2 border-black p-1.5 rounded-full">
              <Video className="w-5 h-5 text-black" />
            </div>
            <h2 className="font-black text-lg md:text-xl">清明連假第一天 Vlog (3/30 作業)</h2>
          </div>
          <div className="flex items-center gap-3">
            <a 
