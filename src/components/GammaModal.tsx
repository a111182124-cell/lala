...
export function GammaModal({ onClose }: { onClose: () => void }) {
  const driveUrl = "https://drive.google.com/file/d/1l5k2B_mbxV2iS8O6iTTHM7LiNuzot7uL/preview";
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      ...
      >
        <div className="bg-[#fdba74] border-b-4 border-black p-4 flex justify-between items-center shrink-0">
          <div className="flex items-center gap-3">
            <div className="bg-white border-2 border-black p-1.5 rounded-full">
              <Presentation className="w-5 h-5 text-black" />
            </div>
            <h2 className="font-black text-lg md:text-xl">清明連假企劃 (3/23 Gamma 作業)</h2>
          </div>
          <div className="flex items-center gap-3">
            <a 
